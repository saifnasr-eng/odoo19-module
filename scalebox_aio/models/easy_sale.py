...
class ScaleboxEasySale(models.Model):
    ...
    # Helpers
    # ------------------------------------------------------------------
    def _so_line_tax_field(self):
        """Odoo 18 uses 'tax_id'; Odoo 19 renamed it to 'tax_ids'."""
    ...
    def _prepare_so_line_vals(self, line):
        ...
        vals[self._so_line_tax_field()] = [(6, 0, line.tax_ids.ids)]
        return vals
    ...
    def _prepare_sale_order_vals(self):
        ...
        return {
            ...
            'origin': self.name,
            'order_line': [(0, 0, self._prepare_so_line_vals(line))
